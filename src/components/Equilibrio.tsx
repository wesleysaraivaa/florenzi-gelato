export const Equilibrio = () => {
  return (
    <section className="relative w-full py-48 bg-florenzi-text text-florenzi-accent flex flex-col items-center justify-center">
      ...
      <button className="mt-32 px-12 py-4 border border-florenzi-accent/20 rounded-full font-sans text-xs uppercase tracking-widest hover:bg-florenzi-accent hover:text-florenzi-text transition-all duration-500">
